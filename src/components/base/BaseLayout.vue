<template>
  <ion-page id="main">
    <ion-header>
      <ion-toolbar>
        <div class="header-container bg-[#f9d9b8] flex items-center justify-between px-5 md:px-0 relative z-10">
          ...
          <div class="action-buttons flex items-center space-x-1">
            ...
            <ion-button fill="clear" @click="$router.push('/cart')" class="basket-button p-0">
              <div class="basket-container relative flex items-center">
                <ion-card class="basket-card">
                  <img src="../../../public/assets/img/basket.png" height="28" width="33" alt="Basket Icon" class="basket-icon m-0" />
