<template>
  <base-layout page-title="Наши акции">
    ...
    <ion-grid v-if="specials.length > 0">
      <ion-row>
        <ion-col v-for="(special, index) in specials" :key="special.key" size="12" size-md="6" class="card-item">
    ...
    <ion-grid v-else-if="specials.constructor === Boolean && !specials">
      <ion-row>
        <ion-col size="12" size-md="6"><specials-item :special="false"></specials-item></ion-col>
        <ion-col size="12" size-md="6"><specials-item :special="false"></specials-item></ion-col>
      </ion-row>
    </ion-grid>
